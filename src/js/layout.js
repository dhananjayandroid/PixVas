...
<div class="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-10">
    ...
    <div class="flex items-center gap-8">
        <nav class="hidden md:flex items-center gap-8">
            <div class="relative group">
                ...
                <div
                    ...
                    <div
                        class="glass-card rounded-2xl p-2 shadow-xl border border-white/20 dark:border-white/10 flex flex-col gap-1 bg-white/80 dark:bg-[#1a1d24]/90 backdrop-blur-xl">
                        <a href="vectorize.html"
                            class="flex items-center gap-3 p-3 rounded-xl hover:bg-primary/5 transition-colors group/item">
                            <div
        ...
        <div class="flex items-center gap-4">
            <div
                class="hidden sm:flex items-center gap-2 rounded-full bg-primary/10 px-4 py-1.5 border border-primary/20">
                <span class="relative flex h-2 w-2">
                    <span
                        class="animate-ping absolute inline-flex h-full w-full rounded-full bg-primary opacity-75"></span>
                    <span class="relative inline-flex rounded-full h-2 w-2 bg-primary"></span>
                </span>
                <span class="text-xs font-bold text-primary uppercase tracking-wide">Free Forever - No
                    Account Needed</span>
            </div>
        </div>
    </div>
...
function injectHeader() {
    ...
    if (headerContainer) {
        ...
        headerContainer.className = "sticky top-0 z-50 w-full border-b border-[#dbdfe6] dark:border-white/10 bg-background-light/80 dark:bg-background-dark/80 backdrop-blur-md";
